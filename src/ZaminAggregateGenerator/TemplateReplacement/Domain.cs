...
internal class Domain
{
    ...
    public Domain(string content, List<PropertyModel> propertyArray, AggregateGeneratorModel aggregateGeneratorModel)
    {
        _content = content;
    ...
    public class Method1Step : ChainStep
    {
        protected override string ProcessStep(string content)
        {
            // منطق Method1
            return content.Replace("Class1old1", "Class1new1");
        }
    }
